      ...
      <div class="flex items-center gap-8">
        <NuxtLink to="/" class="flex items-center gap-2.5 font-bold tracking-tight text-forest-950 transition hover:opacity-85">
          ...
          <div class="flex flex-col">
            ...
            <span class="text-[9px] sm:text-[10px] font-semibold tracking-widest text-forest-700/80 uppercase mt-0.5">Decision Support System</span>
          </div>
        </NuxtLink>
        ...
        <ClientOnly>
          <template v-if="isAuthenticated && user">
            ...
            <div class="relative group">
              <button class="flex items-center gap-2 rounded-xl border border-forest-950/15 bg-forest-50/70 px-3 py-1.5 text-xs font-bold text-forest-950 transition hover:border-forest-900 shadow-2xs cursor-pointer">
              ...
              <div class="absolute right-0 top-full mt-1.5 hidden w-52 rounded-2xl border border-zinc-200 bg-white p-1.5 shadow-premium group-hover:block z-50">
                ...
                <NuxtLink to="/history" class="flex w-full items-center gap-2 rounded-xl px-3 py-2 text-xs font-bold text-zinc-700 hover:bg-forest-50 hover:text-forest-950 transition">
                  <RotateCcw :size="14" class="text-forest-700" />
                  <span>Riwayat Simulasi</span>
                </NuxtLink>
                <button @click="signOut" class="flex w-full items-center gap-2 rounded-xl px-3 py-2 text-xs font-bold text-red-600 hover:bg-red-50 transition cursor-pointer">
                  <LogOut :size="14" />
